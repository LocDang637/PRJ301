...
//        String fileName = p.getFileName().toString(); // Retrieves file name from Path object
        ...
        try {
            ...
            if (!isQuantityPositive || !isYearOfProductionPositive) {
                ...
                Shoes shoes = new Shoes(shoesId, description, Float.parseFloat(price), shoesName, Integer.parseInt(yearOfProduction), Integer.parseInt(quantity), NotSale, fileName);
                boolean result = dao.addShoes(shoes);
                if (result) {
...
// Construct the path to save the file
            ...
            log("ADDShoesServlet + SQLEXCEPTOPN: " + ex.getMessage());
        } finally {
