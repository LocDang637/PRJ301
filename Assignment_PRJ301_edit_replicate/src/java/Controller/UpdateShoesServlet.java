 ...
 * @author ptd
 */
@WebServlet(name = "UpdateShoesServlet", urlPatterns = {"/UpdateShoesServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!isQuantityPositive) {
                ...
                Shoes shoes = new Shoes(shoesId, description, Float.parseFloat(price), "", 0, Integer.parseInt(quantity), NotSale, "");
                boolean result = dao.updateShoes(shoes);
                if (result) {
            ...
            log("UPDATESHOESSERVLET + SQLEXCEPTION: " + ex.getMessage());
        } finally {
